...
Durante o desenvolvimento do projeto, foram aplicadas diversas habilidades técnicas, incluindo:
...
**É requerida a instalação do plugin Live Server para o VSCode**
